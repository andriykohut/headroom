...
private val LightColors = lightColorScheme(
    ...
    // Every role is set, not just the ones this screen names. M3's baseline
    // for anything left out is purple-tinted, and it leaks into Scaffold
    // backgrounds and slider tracks - which is warm, and the design forbids
    // warm anywhere.
    ...
    onSecondaryContainer = Color(0xFF0D2136),
...
private val DarkColors = darkColorScheme(
    ...
    secondary = Color(0xFFB4C6D6),
    onSecondary = Color(0xFF1F313F),
    secondaryContainer = Color(0xFF254566),
    ...
    inversePrimary = Color(0xFF3E5C76),
    scrim = Color(0xFF000000),
